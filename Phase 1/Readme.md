...
|------|-------------|------------------------|---------------|-------------|
| 1 | OOP Foundations (classes, constructors, methods) | Car class, Student Management, BankAccount, Book Library, Rectangle | Constructors, encapsulation, basic methods | [week 1-2/](https://github.com/BugSlayer9000/personal-HNC-journey/tree/main/Phase%201/week%201) |
| 2 | Advanced OOP (encapsulation, properties, inheritance, validation) | Enhanced BankAccount, Improved Student Record, Car Speed Control, User Authentication, Inventory Starter | Private attributes, properties, polymorphism, defensive programming | [week 1-2/](https://github.com/BugSlayer9000/personal-HNC-journey/tree/main/Phase%201/week%202) |
| 3 | Multi-Class Systems (abstract classes, polymorphism) | Library Management (Book, EBook, Member, Library), Online Shopping Cart (Product subtypes, Cart, Payments) | Abstract bases, overrides, real-world logic (e.g., borrowing, taxes) | [week 3/](https://github.com/BugSlayer9000/personal-HNC-journey/tree/main/Phase%201/week%203) |
| 4 | SOLID Principles & GRASP (theory and application) | SOLID examples (SRP, OCP, etc.), GRASP analysis | Responsibility assignment, extensibility, substitutability (integrated into exercises) | [week 4/](https://github.com/BugSlayer9000/personal-HNC-journey/tree/main/Phase%201/week%204) |
| 5 | SOLID Implementations & Decorators | Payment Processing, Document Generator, Database Access Layer, Decorator examples | Interface segregation, dependency inversion, @property, @dataclass | [week 5/](https://github.com/BugSlayer9000/personal-HNC-journey/tree/main/Phase%201/week%205) |
| 6 | Design Patterns & Capstone | Factory/Singleton in Inventory Management CLI (Item types, Manager, Collector) | Pattern application, MVC-like architecture, persistence, CLI design | [week 6/inventory app/](https://github.com/BugSlayer9000/personal-HNC-journey/tree/main/Phase%201/week%206%20Final/inventory%20app) |
